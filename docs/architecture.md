...
| public benchmark adapter | pinned preview pilot plus fresh-public paired config/executor with explicit failed-only resume | official evaluator integration and larger registered comparisons |
