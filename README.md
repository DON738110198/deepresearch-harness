...
- `src/deepresearch_harness/gold_evidence_causal_funnel.py`: hash-bound, zero-call correction that separates gold-document and supporting-evidence arrival before a runtime mechanism is selected.
...
- `docs/gold_evidence_causal_funnel_results_2026-08-17.zh-CN.md`: selected-after-v0 gold-versus-supporting correction, its six mutually exclusive queues, and the fresh-slice boundary before a runtime change.
